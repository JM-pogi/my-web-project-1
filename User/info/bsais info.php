...
$userQuery = "SELECT id, firstname, lastname, mi, usn, Password FROM bsaisuserdata WHERE usn = '$usn' LIMIT 1";
...
<body>
  ...
  <div class="frame">
    ...
    <div class="frame2">
      ...
      <?php if (!$showGrades): ?>
        <form method="POST">
          <label for="password"><b>Enter Code to View Grades</b></label><br />
      ...
      <?php else: ?>
        <?php
          $gradesQuery = "SELECT type, score, total FROM bsaisgrades WHERE user_id = $userId";
    ...
    <a href="user.php" class="back-link" style="text-decoration: none;">Go Back</a>
  </div>
