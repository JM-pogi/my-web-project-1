...
$userQuery = "SELECT id, firstname, lastname, mi, usn, Password FROM bscsuserdata WHERE usn = '$usn' LIMIT 1";
...
<body>
  ...
  <div class="frame">
    <div class="frame2">
      ...
      <?php else: ?>
        <?php
          $gradesQuery = "SELECT type, score, total FROM bscsgrades WHERE user_id = $userId";
